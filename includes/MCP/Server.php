...
class Server {
    ...
    private function get_tools() {
        ...
        $tools = array_merge( $tools, WPRocketIntegration::get_tools() );
        $tools = array_merge( $tools, UpdraftPlusIntegration::get_tools() );
        $tools = array_merge( $tools, WordfenceIntegration::get_tools() );
        $tools = array_merge( $tools, DefenderIntegration::get_tools() );
