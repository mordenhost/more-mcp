...
class Forms {
	...
	const PROVIDERS = array( 'gravityforms', 'fluentforms', 'contactform7', 'wpforms', 'ninjaforms', 'elementor' );
	...
	const ENTRY_PROVIDERS = array( 'gravityforms', 'fluentforms', 'wpforms', 'ninjaforms', 'elementor' );
