...
class Forms {
	...
	const PROVIDERS = array( 'gravityforms', 'fluentforms', 'contactform7', 'wpforms', 'ninjaforms' );
	...
	const ENTRY_PROVIDERS = array( 'gravityforms', 'fluentforms', 'wpforms', 'ninjaforms' );
	...
	public static function get_tools() {
		...
		return array(
			array(
				'name'        => 'forms_list',
				'description' => 'List forms across active form plugins (Gravity Forms, Fluent Forms, Contact Form 7, WPForms, Ninja Forms). Returns id, provider, title, active flag, and entry_count for each. Normalized so every provider looks the same. Contact Form 7 keeps no submissions, so its rows always report entry_count 0; WPForms reports 0 unless WPForms Pro (which stores entries) is active. Read-only.',
				'inputSchema' => array(
					'type'       => 'object',
					'properties' => array(
