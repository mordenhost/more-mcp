...
class Masteriyo {
	...
	public static function get_tools() {
		...
		return array(
			...
			array(
				'name'        => 'mto_list_courses',
				'description' => 'List the Masteriyo course catalogue: each course\'s id, title, slug, status, and price. Read-only enumeration so an agent can discover course IDs to feed mto_get_course_structure. Catalogue fields only — never enrolment rows, learner/user ids, per-student progress, or lesson content. Cannot modify anything.',
				'inputSchema' => array(
					'type'       => 'object',
					'properties' => array(
						'limit'  => array(
