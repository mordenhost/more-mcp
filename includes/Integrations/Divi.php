...
/** Structural read and whole-node write tools for Divi 4 and Divi 5. */
class Divi {
	...
	public static function execute_tool( $name, $args ) {
		// Match Elementor's anti-fingerprint posture: capability before plugin
		// availability, so an unprivileged caller cannot probe whether Divi exists.
	...
	/** Public for the standalone harness; format is content-derived, not version-derived. */
	...
	/** Resolve only paths that the D5 outline exposes. */
