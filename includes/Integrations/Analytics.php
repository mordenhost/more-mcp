...
/**
 * Read-only analytics adapters for locally installed WordPress plugins.
 *
 * This class never owns vendor credentials or calls a vendor API directly.
 * Report methods are used only when the host plugin exposes the required
 * service object; otherwise the response says that the report is unavailable.
 */
class Analytics {
	...
	public static function execute_tool( $name, $args ) {
		// Keep the capability check before availability so lower-privilege callers
		// cannot use an error response to fingerprint installed analytics plugins.
