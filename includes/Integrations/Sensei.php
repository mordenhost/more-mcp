...
class Sensei {
	...
	public static function get_tools() {
		...
		return array(
			...
			array(
				'name'        => 'sensei_list_courses',
				'description' => 'List the Sensei course catalogue: each course\'s id, title, slug, and status. Read-only enumeration so an agent can discover course IDs to feed sensei_get_course_structure. Price is omitted because Sensei core stores none (pricing is a WooCommerce-Paid-Courses extension concern). Catalogue fields only — never enrolment rows, learner/user ids, per-student progress, or lesson content. Cannot modify anything.',
				'inputSchema' => array(
					'type'       => 'object',
					'properties' => array(
						'limit'  => array(
