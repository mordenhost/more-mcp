...
class Analytics4 {
	...
	public static function execute_tool( string $name, array $args ) {
		...
		if ( ! Credentials::is_active( self::SLUG ) ) {
			throw new \Exception( 'Google Analytics 4 is not connected. Add a service account key in Settings → AI Providers → SEO data sources, then grant the service account email Viewer access to the GA4 property.' );
		}
