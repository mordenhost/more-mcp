...
class Blocks {
	...
	private static function map(): array {
		...
		return array(
			...
			'blocks_get_global_styles' => array(
				'type'                 => 'object',
				'additionalProperties' => true,
				'properties'           => array(
					'success'     => array( 'type' => 'boolean' ),
					'origin'      => array( 'type' => 'string', 'enum' => array( 'user', 'theme', 'merged' ) ),
					'stylesheet'  => array( 'type' => 'string' ),
					'writable'    => array( 'type' => 'boolean' ),
					'post_id'     => array( 'type' => array( 'integer', 'null' ) ),
					'mode'        => array( 'type' => 'string', 'enum' => array( 'index', 'paths', 'full' ) ),
					'top_level'   => array( 'type' => 'array', 'items' => array( 'type' => 'string' ) ),
					'paths'       => array( 'type' => 'object', 'additionalProperties' => true ),
					'values'      => array( 'type' => 'object', 'additionalProperties' => true ),
					'settings'    => array( 'type' => 'object', 'additionalProperties' => true ),
					'unset_paths' => array( 'type' => 'array', 'items' => array( 'type' => 'string' ) ),
					'note'        => array( 'type' => 'string' ),
					'warnings'    => array( 'type' => 'array', 'items' => array( 'type' => 'string' ) ),
				),
			),

			'blocks_update_global_styles' => array(
				'type'                 => 'object',
				'additionalProperties' => true,
				'properties'           => array(
					'success'      => array( 'type' => 'boolean' ),
					'mode'         => array( 'type' => 'string', 'enum' => array( 'merge', 'replace' ) ),
					'post_id'      => array( 'type' => array( 'integer', 'null' ) ),
					'stylesheet'   => array( 'type' => 'string' ),
					...
					'changes'      => array(
						...
						'items' => array(
							...
							'properties'           => array(
								'path'   => array( 'type' => 'string' ),
								'action' => array( 'type' => 'string', 'enum' => array( 'add', 'change', 'remove' ) ),
								'note'   => array( 'type' => 'string' ),
							),
						),
					),
					'verified'                => array( 'type' => 'boolean' ),
					'removed_top_level'       => array( 'type' => 'array', 'items' => array( 'type' => 'string' ) ),
					'would_remove_top_level'  => array( 'type' => 'array', 'items' => array( 'type' => 'string' ) ),
					'undo'                    => $undo,
				),
			),
