			...
			<?php if ( $more_mcp_active ) : ?>
				<div class="mmcp-plugin-caps">
					...
					<?php if ( is_array( $more_mcp_plugin['abilities'] ?? null ) ) : ?>
						...
						$more_mcp_card_names = $more_mcp_plugin['abilities']['names'];
						?>
						<div class="mmcp-cap-row mmcp-cap-abilities-head">
							<span class="mmcp-cap-label">
								<strong><?php esc_html_e( 'Abilities', 'more-mcp' ); ?></strong>
								<span class="mmcp-cap-count"><?php echo esc_html( number_format_i18n( (int) $more_mcp_plugin['abilities']['count'] ) ); ?></span>
							</span>
							<span class="mmcp-cap-note"><?php esc_html_e( 'third-party code, no dry-run or undo', 'more-mcp' ); ?></span>
						</div>
						<ul class="mmcp-ability-picker">
							<?php foreach ( $more_mcp_card_names as $more_mcp_ab_name ) : ?>
								<?php
