...
<?php if ( 'wordpress' === $more_mcp_perm_view ) : ?>
	...
	<div class="mmcp-perm-group">
		...
		<div class="mmcp-scope mmcp-scope-critical <?php echo $more_mcp_perm_ai_media ? 'is-on' : ''; ?><?php echo $more_mcp_ai_ineffective ? ' is-ineffective' : ''; ?>">
			<div class="mmcp-scope-head">
				<label class="switch small"<?php echo $more_mcp_ai_ineffective ? ' title="' . esc_attr__( 'On, but no AI provider key is configured, so no tools are exposed yet.', 'more-mcp' ) . '"' : ''; ?>>
					<input type="checkbox"
					       class="mmcp-scope-toggle"
		...
		<?php  ?>
		<?php $more_mcp_snip_ineffective = $more_mcp_perm_snippets && ! $more_mcp_dep_snippets_active; ?>
		<div class="mmcp-scope mmcp-scope-critical <?php echo $more_mcp_perm_snippets ? 'is-on' : ''; ?><?php echo $more_mcp_snip_ineffective ? ' is-ineffective' : ''; ?>">
			<div class="mmcp-scope-head">
				<label class="switch small"<?php echo $more_mcp_snip_ineffective ? ' title="' . esc_attr__( 'On, but the Code Snippets plugin is not installed, so no tools are exposed yet.', 'more-mcp' ) . '"' : ''; ?>>
					<input type="checkbox"
					       class="mmcp-scope-toggle"
