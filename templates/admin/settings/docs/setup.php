    ...
    "more-mcp": {
      ...
      "args": [
        ...
        "MMCP-Key:<span class="mmcp-guide-key" data-live="masked" data-masked="<?php echo esc_attr( $more_mcp_guide_key ); ?>"><?php echo esc_html( $more_mcp_guide_key ); ?></span>"
					...
					<button type="button" class="button button-small mmcp-reveal-guide-key" aria-label="<?php esc_attr_e( 'Reveal the real API key in this example', 'more-mcp' ); ?>">
						<span class="dashicons dashicons-visibility" aria-hidden="true"></span>
						<span class="mmcp-reveal-guide-key-label"><?php esc_html_e( 'Reveal key in this example', 'more-mcp' ); ?></span>
					</button>
				</li>
