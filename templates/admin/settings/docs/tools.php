...
$more_mcp_tool_groups = [
	...
	'discovered_'  => [
		...
		'summary' => __( 'Abilities other plugins registered with the WordPress Abilities API, wrapped as tools. Present only for abilities you explicitly enabled on the Permissions panel; they run the other plugin\'s own code and carry none of More MCP\'s dry-run / undo guards.', 'more-mcp' ),
	],
	'wp_'          => [
