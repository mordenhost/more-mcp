...
$more_mcp_panels = [
    'connection'  => [
        ...
        'summary'  => __('Status, connect a client, API key, session length, and OAuth setup.', 'more-mcp'),
        'section'  => 'setup',
    ],
    'permissions' => [
        'label'    => __('Access', 'more-mcp'),
        'dashicon' => 'dashicons-shield',
        'summary'  => __('What connected agents may change, plus which plugins back each capability.', 'more-mcp'),
        'section'  => 'setup',
    ],
    'sessions'    => [
        'label'    => __('Sessions', 'more-mcp'),
        'dashicon' => 'dashicons-clock',
        'summary'  => __('Who is connected right now: OAuth clients and transport sessions.', 'more-mcp'),
        'section'  => 'operate',
    ],
    'services'    => [
...
$more_mcp_nav_sections = [
    'setup'   => __('Set up', 'more-mcp'),
    'operate' => __('Operate', 'more-mcp'),
    'help'    => __('Help', 'more-mcp'),
];
...
$more_mcp_preserve = function () use ($more_mcp_settings, $more_mcp_panel_owns, $more_mcp_owner_key) {
    ...
    $bools   = ['enabled', 'allow_option_writes', 'allow_theme_writes', 'allow_plugin_management', 'allow_ai_media', 'allow_code_snippets', 'allow_discovered_tools'];

    
    
    $scalars = ['oauth_client_id', 'oauth_client_secret', 'access_token_ttl_seconds'];
...
$more_mcp_readonly_panel = in_array($more_mcp_active, ['docs', 'permissions'], true);
