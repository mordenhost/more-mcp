<?php
/**
 * Plugin Name: More MCP – WordPress MCP Server with OAuth 2.0 (works with Claude, ChatGPT & Gemini)
...
define('MORE_MCP_VERSION', '0.13.1');
...
class More_MCP_Plugin {
    ...
    public function maybe_upgrade_db() {
        ...
        if ($token_store_ok && $session_store_ok && $edit_trail_store_ok) {
            update_option('more_mcp_db_version', MORE_MCP_VERSION);
        }
